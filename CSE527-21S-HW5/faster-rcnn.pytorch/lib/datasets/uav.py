...
class uav(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        self._angle_to_ind = {'front-side-view': 0, 'front-view': 0, 'side-view': 1, 'bird-view': 2}
        #self._angle_to_ind = {'front-side-view':0, 'front-view':1, 'side-view':2, 'bird-view':3}
        #self._angleto_ind = {'front-side-view': 0, 'front-view': 1, 'side-view': 0, 'bird-view': 2}
        self._image_ext = '.jpg'
    ...
    def evaluate_detections(self, all_boxes, output_dir, nuisance_type, baseline_method=False, ovthresh=0.5):
        ...
        path = os.path.join('data/results', 'UAV' + self._year, str(self._epoch),
                            str(self._ckpt))
